...
const Bubble = ({
  ...
  return (
    <div className="w-full h-full flex items-center lg:px-32 justify-end relative">
      <div
        className={cn(
          "shadow-md shadow-black/80 w-full max-w-[600px] pb-3 h-full max-h-fit rounded-xl transition-all relative duration-300 ease-in-out bg-white/60 overflow-y-scroll",
          {
